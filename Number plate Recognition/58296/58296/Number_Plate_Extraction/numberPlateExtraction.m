...
f=imread('test3.jpg'); % Reading the number plate image.
s=serial('COM3')
counter=0;
fopen(s)
...
if strcmp(noPlate,'OJP1D') 
   h=msgbox('KL 10 AF 2266')
   
else if strcmp(noPlate,'ON8001')
        h=msgbox('WB 02W 6866')
        counter=counter+1;
       
else if strcmp(noPlate,'L433JC')
        h=msgbox('MH 12 DE 1433')
        counter=counter+1;
      
else if strcmp(noPlate,'CAF494')
        h=msgbox('DL 4C AF 4943')
        counter=counter+1;
       
else h=msgbox('unknown ')
    end
    end
    end
end
